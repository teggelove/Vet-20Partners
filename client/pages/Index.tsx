    ...
    <div className="min-h-screen bg-bfp-beige">
      ...
      <div className="sticky top-0 z-50 bg-bfp-light-teal">
        ...
        <div className="relative z-10 bg-bfp-peach py-3 px-4 text-center mx-auto max-w-7xl">
          <p className="text-black text-xs md:text-base leading-tight">
            Share your photo on Insta and tag{" "}
            <span className="font-bold">@bestforpet</span> for your chance to
            win a Best for Pet Wellness Plan
          </p>
        </div>
        ...
        <header className="relative z-10 bg-white md:rounded-b-xl mx-auto max-w-7xl px-4 md:px-8 md:h-[79px]">
          <div className="flex items-center justify-between py-2 md:py-0 h-full">
            ...
            <nav className="hidden lg:flex items-center gap-6 xl:gap-12">
              <a
                href="#"
                className="text-bfp-dark-emerald font-medium text-base hover:text-bfp-dark-teal transition-colors"
              >
                Wellness Plan
              </a>
              <a
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="space-y-1 md:space-y-6">
                ...
                <p className="text-bfp-dark-emerald text-base md:text-xl leading-[134%] px-2.5 py-1">
                  Celebrate the festive season with your furry family and turn
                  them into a cartoon.
                </p>
            ...
            <div className="bg-white rounded-xl py-8 px-6 flex flex-col">
              <div className="flex flex-col items-end gap-[13px]">
                <div className="flex justify-center items-center gap-2 w-full">
                  ...
                  >
                    <path
                      d="M35.75 35.75H8.25C7.52065 35.75 6.82118 35.4603 6.30546 34.9445C5.78973 34.4288 5.5 33.7293 5.5 33V13.75C5.5 13.0207 5.78973 12.3212 6.30546 11.8055C6.82118 11.2897 7.52065 11 8.25 11H13.75L16.5 6.875H27.5L30.25 11H35.75C36.4793 11 37.1788 11.2897 37.6945 11.8055C38.2103 12.3212 38.5 13.0207 38.5 13.75V33C38.5 33.7293 38.2103 34.4288 37.6945 34.9445C37.1788 35.4603 36.4793 35.75 35.75 35.75Z"
                      stroke="#00302D"
                      strokeWidth="3"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M22 28.875C25.4173 28.875 28.1875 26.1048 28.1875 22.6875C28.1875 19.2702 25.4173 16.5 22 16.5C18.5827 16.5 15.8125 19.2702 15.8125 22.6875C15.8125 26.1048 18.5827 28.875 22 28.875Z"
                      stroke="#00302D"
                      strokeWidth="3"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  <h3 className="text-black font-bold text-2xl leading-[116%]">
                    Snap
                  </h3>
                </div>
              ...
              <div className="flex flex-col items-start gap-[18px]">
                <div className="flex justify-center items-center gap-2 w-full">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M32.9062 21.9375V31.6875H6.09375V21.9375"
                      stroke="#00302D"
                      strokeWidth="3"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M13.4062 10.9688L19.5 4.875L25.5938 10.9688"
                      stroke="#00302D"
                      strokeWidth="3"
                      strokeLinecap="round"
                      strokeLinejoin="round"
            ...
            <div className="bg-white rounded-xl py-8 px-6 flex flex-col">
              <div className="flex flex-col items-center gap-[18px]">
                <div className="flex justify-center items-center gap-2">
                  ...
                  >
                    <path
                      d="M26.8125 23.1562L34.125 15.8438L26.8125 8.53125"
                      stroke="#00302D"
                      strokeWidth="3"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M29.25 32.9062H4.875V13.4062"
                      stroke="#00302D"
                      strokeWidth="3"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M10.9688 26.8125C11.7796 23.6719 13.6115 20.89 16.1763 18.9044C18.7411 16.9188 21.8932 15.8421 25.1367 15.8438H34.125"
                      stroke="#00302D"
                      strokeWidth="3"
                      strokeLinecap="round"
                      strokeLinejoin="round"
      ...
      <section className="md:py-12 md:px-4 lg:py-20 lg:px-8">
        <div className="bg-bfp-dark-teal px-4 py-12 md:rounded-2xl md:p-6 md:max-w-7xl md:mx-auto lg:p-12">
            ...
            <div className="grid lg:grid-cols-[481px_1fr] gap-6 items-start">
              ...
              <div className="bg-white rounded-2xl md:rounded-xl border border-dashed border-black flex md:flex-col items-center gap-4 md:gap-0 px-6 py-6 md:p-8 lg:p-12 md:justify-center md:space-y-3 md:h-[339px] hover:border-bfp-dark-teal transition-colors cursor-pointer">
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="flex-shrink-0 md:w-[86px] md:h-[86px]"
                >
                  <path
                    d="M21.5 24.1875V5.375"
                    stroke="#008D84"
                    strokeWidth="3"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M36.2812 24.1875V34.9375H6.71875V24.1875"
                    stroke="#008D84"
                    strokeWidth="3"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M14.7812 12.0938L21.5 5.375L28.2188 12.0938"
                    stroke="#008D84"
                    strokeWidth="3"
                    strokeLinecap="round"
                    strokeLinejoin="round"
        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex flex-col items-center gap-5 text-center">
            ...
            <p className="text-bfp-dark-emerald font-medium text-lg md:text-xl leading-[144%] max-w-2xl">
              Share this page with friends and family so they can create their
              own festive, AI-generated polaroid with their pets!
            </p>
            ...
            <div className="flex items-center gap-2 md:gap-3 mt-2">
              ...
              <a
                href="#"
                className="w-[47px] h-[47px] md:w-[74px] md:h-[74px] rounded-full bg-bfp-dark-teal flex items-center justify-center hover:opacity-90 transition-opacity"
              >
                <svg
                  viewBox="0 0 40 40"
                  fill="none"
                ...
                >
                  <path
                    d="M15.0767 9.77516V14.3552H11.72V19.9552H15.0767V36.5985H21.9667V19.9568H26.5917C26.5917 19.9568 27.025 17.2718 27.235 14.3352H21.995V10.5052C21.995 9.9335 22.745 9.1635 23.4883 9.1635H27.245V3.3335H22.1383C14.905 3.3335 15.0767 8.9385 15.0767 9.77516V9.77516Z"
                    fill="white"
                  />
                </svg>
              </a>
              ...
              >
                ...
                >
                  <path
                    d="M29.5314 4.99316H34.6116L23.5155 17.7603L36.6169 35.0727H26.323L18.3017 24.5783L9.07735 35.0727H3.99725L15.8954 21.4367L3.32881 4.99316H13.8901L21.176 14.6186L29.5314 4.99316ZM27.7267 31.9979H30.5341L12.3527 7.86743H9.27788L27.7267 31.9979Z"
                    fill="white"
                  />
                </svg>
              </a>
      ...
      {/* Footer */}
      <footer className="bg-bfp-dark-emerald text-white py-5 px-6 md:py-10 md:px-8 mt-12">
        <div className="md:max-w-7xl md:mx-auto">
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pt-2">
              {/* Wellness Plan */}
              <div className="flex flex-col">
                <h3 className="font-bold text-base leading-[116%] mb-3">
                  Wellness Plan
                </h3>
                <ul className="space-y-3 text-sm leading-[0.63]">
                  <li>
                    <a
                      href="#"
                      className="hover:text-bfp-teal-accent transition-colors"
                    >
                      What's included?
                    </a>
                  </li>
