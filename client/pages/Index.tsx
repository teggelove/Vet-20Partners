        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex flex-col items-center gap-5 text-center">
            ...
            <div className="flex items-center gap-2 md:gap-3 mt-2">
              ...
              {/* Instagram */}
              <a href="#" className="w-[47px] h-[47px] md:w-[74px] md:h-[74px] rounded-full bg-bfp-dark-teal flex items-center justify-center hover:opacity-90 transition-opacity">
                <svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 md:w-10 h-6 md:h-10">
              ...
              {/* Email */}
              <a href="#" className="w-[47px] h-[47px] md:w-[74px] md:h-[74px] rounded-full bg-bfp-dark-teal flex items-center justify-center hover:opacity-90 transition-opacity">
                <svg viewBox="0 0 37 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 md:w-9 h-4 md:h-7">
      ...
      <footer className="bg-bfp-dark-emerald text-white py-5 px-6 md:py-10 md:px-8 mt-12">
        <div className="md:max-w-7xl md:mx-auto">
          <div className="space-y-8">
            {/* Logo */}
            <div className="py-5">
              <svg width="233" height="87" viewBox="0 0 233 87" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-12 md:h-20 lg:h-[87px] w-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-center justify-center gap-2.5">
                <a href="#" className="hover:opacity-70 transition-opacity">
                  <svg className="w-5 h-5 md:w-6 md:h-6" fill="#D6D6D6" viewBox="0 0 22 22">
                ...
                <a href="#" className="hover:opacity-70 transition-opacity">
                  <svg className="w-5 h-5 md:w-6 md:h-6" fill="#D6D6D6" viewBox="0 0 23 23">
                ...
                <a href="#" className="hover:opacity-70 transition-opacity">
                  <svg className="w-4 h-4 md:w-5 md:h-5" fill="#D6D6D6" viewBox="0 0 18 18">
                ...
                <a href="#" className="hover:opacity-70 transition-opacity">
                  <svg className="w-5 h-5 md:w-6 md:h-6" fill="#D6D6D6" viewBox="0 0 24 24">
