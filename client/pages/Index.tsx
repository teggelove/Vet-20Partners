        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex flex-col items-center gap-5 text-center">
            ...
            <div className="flex items-center gap-2 md:gap-3 mt-2">
              ...
              {/* Instagram */}
              <a href="#" className="w-[47px] h-[47px] md:w-[74px] md:h-[74px] rounded-full bg-bfp-dark-teal flex items-center justify-center hover:opacity-90 transition-opacity">
                <svg width="24" height="24" md:width="40" md:height="40" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 md:w-10 h-6 md:h-10">
              ...
              {/* Email */}
              <a href="#" className="w-[47px] h-[47px] md:w-[74px] md:h-[74px] rounded-full bg-bfp-dark-teal flex items-center justify-center hover:opacity-90 transition-opacity">
                <svg width="22" height="18" md:width="37" md:height="30" viewBox="0 0 37 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5.5 md:w-9 h-4.5 md:h-7.5">
